...
static void
gst_native_init (JNIEnv * env, jobject thiz, jstring gstPipeline)
{
  ...
  pipeline = (gchar*)(*env)->GetStringUTFChars (env, gstPipeline, NULL);
...
JNI_OnLoad (JavaVM * vm, void *reserved)
{
  ...
  jclass klass = (*env)->FindClass (env, "com/neosecu/intercom/NSIntercom");
